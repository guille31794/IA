...
//Encuentra la fila en la que se situa el hueco en el estado actual
int filaDelHueco(tEstado *estado);

//Ecuentra la columna en la que se situa el hueco en el estado actual
int columnaDelHueco(tEstado *estado);

//Indica el número de piezas mal colocadas
