...
//Post:Devuelve el elemento i-esimo de la lista C (no lo elimina de la lista)
...
//Post: añade un elemento el ultimo de la lista
...
//Pre: Lista C no esta llena
//Post: añade un elemento primero de la lista
